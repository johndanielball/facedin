...
---------------------
Let's create a new **clientapp.js** file that we will use to show the basic CRUD operations using the MongoDB driver.
...
We can now run the update **clientapp.js** file.

```
node clientapp.js
```

You should see the following output after running the **clientapp.js** file.
